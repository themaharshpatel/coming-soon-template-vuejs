<template>
  <b-row no-gutters class="h-100 template-one">
    ...
    <b-col cols="12" sm="6" xl="4" class="bg-light p-3 d-flex flex-column justify-content-center align-items-center shadow-lg">
      ...
      <div class="mt-auto text-center social-media-container">
        ...
        <a v-if="mail" :href="'mailto:'+mail" target="_blank" class="text-body mx-2 my-3">Email</a>
      </div>
      <div class="mt-auto text-center social-media-container">
        <a href="https://github.com/kgkanatsios/coming-soon-template-vuejs" target="_blank" class="text-body mx-2 my-6">Website credits @kgkanatsios</a>
      </div>
    </b-col>
  </b-row>
</template>
...
export default {
  ...
  data(){
    return {
      ...
      backgroundImage: require('@/assets/bg.svg'),
